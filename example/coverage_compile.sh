...
$CC -g -fprofile-arcs -ftest-coverage -DFUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION test.c -o test
...
$AFL_COV/afl-cov.sh -c ../target/obj-afl/temp/fuzz/afl-out "./test AFL_FILE"